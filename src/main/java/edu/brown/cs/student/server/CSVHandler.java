...
public class CSVHandler implements Route {
  ...
  public Object handle(Request request, Response response) throws Exception {
    ...
    if (path.equals("/loadcsv")) {
      ...
      return new CSVFailureResponse(
          "Invalid endpoint. Available endpoints: /loadcsv, /viewcsv, /searchcsv");
    }
  }
  ...
  private Object handleSearchCSV(Request request, Response response) throws Exception {
    ...
    try {
      ...
      // We will use FuzzySearchProcessor for search - but this can easily be changed to an exact
      // search!
  ...
  public record CSVSuccessResponse(String response_type, Map<String, Object> responseMap) {
    ...
    String serialize() {
      try {
        ...
        JsonAdapter<CSVHandler.CSVSuccessResponse> adapter =
