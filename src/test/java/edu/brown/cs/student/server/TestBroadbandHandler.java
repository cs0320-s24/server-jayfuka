...
public class TestBroadbandHandler {
    ...
    public void testAPIValidState() throws IOException {
        ...
        HttpURLConnection clientConnection = tryRequest("broadband?state=rhodeisland&county=providencecounty");
        assertEquals(200, clientConnection.getResponseCode());
        Moshi moshi = new Moshi.Builder().build();
        ...
        String expected = "{broadband_data={dateTime=" + time + ", broadbandData=[[Providence County, Rhode Island, 85.4, 44, 007]]}}";
    ...
    public void testAPIInvalidState() throws IOException {
        ...
        HttpURLConnection clientConnection = tryRequest("broadband?state=invalid&county=providencecounty");
        assertEquals(200, clientConnection.getResponseCode());
        Moshi moshi = new Moshi.Builder().build();
        BroadbandHandler.BroadbandSuccessResponse response =
                moshi
                        .adapter(BroadbandHandler.BroadbandSuccessResponse.class)
                        .fromJson(new Buffer().readFrom(clientConnection.getInputStream()));
        String expected = "BroadbandSuccessResponse[response_type=error, responseMap=null]";
